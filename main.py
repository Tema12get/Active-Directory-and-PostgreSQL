...
class UserManagementWindow(QWidget):
    ...
    def __init__(self, ad_domain: str, ad_admin_user: str, ad_admin_password: str,
                 pg_host: str, pg_admin_user: str, pg_admin_password: str):
        """
    ...
    def connect_to_ad(self, use_ssl: bool = True) -> ldap3.Connection:
        """
        Создает подключение к Active Directory.

        Args:
            use_ssl (bool): Использовать SSL для подключения (по умолчанию True).
    ...
    def load_ad_organizational_units(self):
        ...
        try:
            ...
            QApplication.processEvents()
            connection = self.connect_to_ad(use_ssl=True)
            connection.search(
    ...
    def on_postgres_user_selected(self):
        ...
        При выборе пользователя в списке `postgres_users_list` извлекает логин из данных элемента
        и устанавливает его в поле `login_input`.
        """
    ...
    def create_ad_user(self, display_name: str, login: str, password: str, ou_distinguished_name: str):
        ...
        # Установка пароля (требует LDAPS)
...
class LoginWindow(QWidget):
    ...
    def open_main_window(self, ad_domain: str, ad_admin_user: str, ad_admin_password: str,
                        postgres_host: str, postgres_admin_user: str, postgres_admin_password: str):
        """
